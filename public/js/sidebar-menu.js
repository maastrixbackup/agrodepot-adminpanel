(function ($) {
  ...
  if ($("#pageWrapper").hasClass("compact-wrapper")) {
    ...
    jQuery(".submenu-title").click(function () {
      jQuery(".submenu-title").removeClass("active"); // Remove active class from all submenu titles
      jQuery(".submenu-title")
        .find("div")
        .replaceWith(
          '<div class="according-menu"><i class="fa fa-angle-right"></i></div>'
        );
      jQuery(".submenu-content").slideUp("normal"); // Hide all submenu contents
      if (jQuery(this).next().is(":hidden") == true) {
        jQuery(this).addClass("active"); // Add active class to the clicked submenu title
        jQuery(this)
          .find("div")
          .replaceWith(
            '<div class="according-menu"><i class="fa fa-angle-down"></i></div>'
          );
        jQuery(this).next().slideDown("normal"); // Show the corresponding submenu content
      } else {
        jQuery(this)
          .find("div")
          .replaceWith(
