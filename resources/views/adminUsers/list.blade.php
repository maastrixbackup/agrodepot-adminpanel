                    ...
                    <tr>
                        ...
                        <td class="text-capitalize">
                            ...
                            @else
                                Inactive
                            @endif
                        <td class="text-capitalize">{{ \Carbon\Carbon::parse($menu->created_at)->format('d/m/Y') }}</td>
                        <td>
                            <div class="d-flex customButtonContainer">
                                ...
                                <a class="edit-btn" title="Edit"
                                    href="{{ url('admin/admin-users/' . $menu->uid . '/edit') }}"><i
                                        class="fas fa-edit"></i></a>
                                <a class="edit-btn" title="View"
                                    href="{{ url('admin/admin-users/' . $menu->uid) }}"><i class="fas fa-eye"></i></a>
                                <button title="Delete" class="dl-btn trash remove-adminuser"
                                    data-id="{{ $menu->uid }}"
                                    data-action="{{ url('admin/admin-users/' . $menu->uid) }}"><i
