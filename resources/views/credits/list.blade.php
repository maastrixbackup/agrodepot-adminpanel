                ...
                <td>
                    <div class="d-flex">
                        <div class="customButtonContainer">
                            <a class="mx-2" href="{{ url('admin/credits/' . $menu->credit_id . '/edit') }}"><i class="fas fa-eye"></i></a>
                            <a class="mx-2" href="{{ url('admin/credits/' . $menu->user_id) }}"><i class="fas fa-eye"></i></a>
                        </div>
                        <div class="customButtonContainer">
                            ...
                            <button title="Delete" class="trash remove-credits" data-id="{{ $menu->credit_id }}" data-action="{{ url('admin/credits/' . $menu->credit_id ) }}"><i class="fas fa-trash"></i></button>
                        </div>
                    </div>
                    </div>
                </td>
