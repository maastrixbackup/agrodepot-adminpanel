<x-app-layout>
    <div class="row">
        ...
        <div class="col-2"><a href="{{ route('templates.create') }}" class="btn btn-primary">Create new</a></div>
    </div>
                        ...
                        <td>
                            <div class="d-flex customButtonContainer">
                                ...
                                <a class="edit-btn" title="Edit"
                                    href="{{ url('admin/templates/' . $menu->compose_id . '/edit') }}"><i
                                        class="fas fa-edit"></i></a>

                                <a class="edit-btn" title="View"
                                    href="{{ url('admin/templates/' . $menu->compose_id) }}"><i
                                        class="fas fa-eye"></i></a>

                                <button title="Delete" class="dl-btn trash remove-templates"
                                    data-id="{{ $menu->compose_id }}"
                                    data-action="{{ url('admin/templates/' . $menu->compose_id) }}"><i
