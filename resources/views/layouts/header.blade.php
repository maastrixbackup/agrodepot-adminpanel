    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        <div class="page-header row">
            ...
            <div class="col-4 col-xl-4 page-title head-left">
                ...
                <nav>
                    <ol class="breadcrumb justify-content-sm-start align-items-center mb-0" id="breadcrumb-trail">
                        <li class="breadcrumb-item"><a href="#"> <i data-feather="home"> </i></a></li>
                        <li class="breadcrumb-item f-w-400">Dashboard</li>
                        <li class="breadcrumb-item f-w-400 active" id="breadcrumb-current"></li>
                    </ol>
                </nav>
            </div>
            <!-- Page Header Start-->
                        ...
                        <ul class="nav-menus">
                            ...
                            <li class="profile-nav onhover-dropdown px-0 py-0">
                                <div class="d-flex profile-media align-items-center">
                                    <img class="img-30 rounded-circle p-1 bg-primary"
                                        src="{{ Auth::user()->prof_img ? asset('uploads/adminprofile/' . Auth::user()->prof_img) : asset('images/profile.png') }}"
                                        alt="Profile Image">
                                    ...
                                    <li>
                                        <form method="POST" action="{{ route('logout') }}">
                                            ...
                                            <x-dropdown-link :href="route('logout')"
                                                ...
                                                class="logout-btn"><i class="fas fa-sign-out-alt"></i>
                                                {{ __('Log Out') }}
                                            </x-dropdown-link>
                                        </form>
                                    </li>
