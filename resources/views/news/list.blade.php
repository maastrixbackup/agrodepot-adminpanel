    ...
    <table class="table table-hover" id="cmspageslist">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="tableImgLogo"><img src="{{ asset('uploads/news/' . $menu->news_img) }}" alt=""> </td>
                ...
                <td>
                    <div class="d-flex">
                        <div class="customButtonContainer"><a class="mx-2" href="{{ url('admin/news/' . $menu->news_id . '/edit') }}"><i class="fas fa-edit"></i></a>
                        </div>
                        <div class="customButtonContainer">
                            ...
                            <button title="Delete" class="trash remove-news" data-id="{{ $menu->news_id }}" data-action="{{ url('admin/news/' . $menu->news_id) }}"><i class="fas fa-trash"></i></button>
                        </div>
                    </div>
