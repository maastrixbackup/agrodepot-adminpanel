<x-app-layout>
    <div class="row">
        ...
        <div class="col-2"><a href="{{ route('compose-mail.create') }}" class="btn btn-primary">Compose Mail</a></div>
    </div>
                ...
                <td>
                    <div class="d-flex">
                        <div class="customButtonContainer">
                            <a href="{{ url('admin/compose-mail/' . $menu->compose_id . '/edit') }}"><i class="fas fa-edit"></i></a>
                        </div>
                        <div class="customButtonContainer">
                            ...
                            <button title="Delete" class="trash remove-composemail" data-id="{{ $menu->compose_id }}" data-action="{{ url('admin/compose-mail/' . $menu->compose_id ) }}"><i class="fas fa-trash"></i></button>
                        </div>
                    </div>
