<x-app-layout>
    <div class="row">
        ...
        <div class="col-10">
            <h1 class="text-center mb-3">Manage Pages</h1>
        </div>
                        ...
                        <td>
                            <div class="d-flex customButtonContainer">
                                ...
                                <a class="edit-btn" title="Edit"
                                    href="{{ url('admin/pages/' . $menu->pid . '/edit') }}"><i
                                        class="fas fa-edit"></i></a>
                                <a class="edit-btn" title="View" href="{{ url('admin/pages/' . $menu->pid) }}"><i
                                ...
                                <button title="Delete" class="dl-btn trash remove-pages" data-id="{{ $menu->pid }}"
                                    data-action="{{ url('admin/pages/' . $menu->pid) }}"><i
