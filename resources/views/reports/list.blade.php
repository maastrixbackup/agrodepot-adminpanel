    ...
    <table class="brandsTable table table-hover" id="cmspageslist">
        ...
        <tbody id="brands_sortable">
            ...
            <tr id="{{ $menu->question_id  }}">
                ...
                <td class="text-capitalize"><select name="status" class="form-select-sm qus-select" data-qu-id="{{ $menu->question_id }}">
                ...
                <td>
                    <div class="d-flex">
                        <div class="customButtonContainer">
                            ...
                            <a class="mx-2" href="{{ url('admin/reports/' . $menu->question_id) }}"><i class="fas fa-eye"></i></a>
                        </div>
                        <div class="customButtonContainer">
                            ...
                            <button title="Delete" class="trash remove-reports" data-id="{{ $menu->question_id }}" data-action="{{ url('admin/reports/' . $menu->question_id) }}"><i class="fas fa-trash"></i></button>
                        </div>
                    </div>
