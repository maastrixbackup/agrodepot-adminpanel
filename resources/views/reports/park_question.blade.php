    ...
    <table class="brandsTable table table-hover" id="cmspageslist">
        ...
        <tbody id="brands_sortable">
            ...
            <tr id="{{ $menu->qid}}">
                ...
                <td scope="row">@if($menu->park_type == 1)
                    Park Trucks
                    @else
                    Company Parts
                    @endif</td>
                ...
                <td>
                    <div class="d-flex">
                        <div class="customButtonContainer">
                            ...
                            <a class="mx-2" href="{{ url('admin/parkquestion/' . $menu->qid) }}"><i class="fas fa-eye"></i></a>
                        </div>
                        <div class="customButtonContainer">
                            ...
                            <button title="Delete" class="trash remove-parkquestion" data-id="{{ $menu->qid }}" data-action="{{ url('admin/parkquestion/' . $menu->qid) }}"><i class="fas fa-trash"></i></button>
                        </div>
                    </div>
