    ...
    <table class="brandsTable table table-hover" id="cmspageslist">
        ...
        <tbody id="brands_sortable">
            ...
            <tr id="{{ $menu->request_id  }}">
                ...
                <td class="text-capitalize"><select name="status" class="form-select-sm part-select" data-part-id="{{ $menu->request_id }}">
                ...
                <td>
                    <div class="d-flex">
                        <div class="customButtonContainer">
                            ...
                            <a class="mx-2" href="{{ url('admin/request-parts/' . $menu->request_id) }}"><i class="fas fa-eye"></i></a>
                        ...
                        <div class="customButtonContainer">
                            ...
                            <button title="Delete" class="trash remove-requestpart" data-id="{{ $menu->request_id }}" data-action="{{ url('admin/request-parts/' . $menu->request_id) }}"><i class="fas fa-trash"></i></button>
                        </div>
                    </div>
