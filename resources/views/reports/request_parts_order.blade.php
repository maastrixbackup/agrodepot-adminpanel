    ...
    <table class="brandsTable table table-hover" id="cmspageslist">
        ...
        <tbody id="brands_sortable">
            ...
            <tr id="{{ $menu->request_id  }}">
                ...
                <td scope="row">{{ optional($menu->user)->first_name}} {{ optional($menu->user)->last_name}}</td>
                ...
                <td scope="row">@if ($menu->status == 0) Confirmed Order @endif</td>
                ...
                <td>
                    <div class="d-flex">
                        <div class="customButtonContainer">
                            ...
                            <a class="mx-2" data-toggle="modal" data-target="#parts_order" href="{{ url('admin/requestparts/' . $menu->id) }}"><i class="fas fa-eye"></i></a>
                        </div>
                        <div class="customButtonContainer">
                            ...
                            <button title="Delete" class="trash remove-requestparts" data-id="{{ $menu->id }}" data-action="{{ url('admin/requestparts/' . $menu->id) }}"><i class="fas fa-trash"></i></button>
                        </div>
                    </div>
