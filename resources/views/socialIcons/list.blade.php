    ...
    <table class="brandsTable table table-hover" id="cmspageslist">
        ...
        <tbody id="brands_sortable">
            ...
            <tr id="{{ $menu->social_id }}">
                ...
                <td scope="row"><img src="{{ asset('uploads/socialicon/' . $menu->social_img) }}" height="30px" width="30px"></td>
                <td scope="row">{{ $menu->social_link }}</td>
                <td scope="row">{{ $menu->orderno }}</td>
                <td scope="row">{{ $menu->created }}</td>
                <td>
                    <div class="d-flex">
                        <div class="customButtonContainer"><a class="mx-2" href="{{ url('admin/socialicons/' . $menu->social_id . '/edit') }}"><i class="fas fa-edit"></i></a>
                        </div>
                        <div class="customButtonContainer">
                            ...
                            <button title="Delete" class="trash remove-socialicons" data-id="{{ $menu->social_id }}" data-action="{{ url('admin/socialicons/' . $menu->social_id) }}"><i class="fas fa-trash"></i></button>
                        </div>
                    </div>
